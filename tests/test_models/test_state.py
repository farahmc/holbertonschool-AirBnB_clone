...
class TestState(unittest.TestCase):
    ...
    def test_has_attributes(self):
        ...
        self.assertTrue('id' in Victoria.__dict__)
        self.assertTrue('created_at' in Victoria.__dict__)
        self.assertTrue('updated_at' in Victoria.__dict__)
        self.assertTrue('name' in Victoria.__dict__)
